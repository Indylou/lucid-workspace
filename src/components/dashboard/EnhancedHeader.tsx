...
import { ChevronDown, LogOut, Settings, User, Edit, FileEdit } from "lucide-react";
  ...
  return (
    <header className="border-b">
      <div className="flex h-16 items-center px-4">
        <div className="font-bold text-2xl">Lucid Team</div>
          ...
          <Tabs defaultValue={getActiveTab()} className="hidden md:block">
            <TabsList className="inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground">
              ...
              <TabsTrigger 
                ...
                onClick={() => navigate("/tiptap-enhanced")}
              >
